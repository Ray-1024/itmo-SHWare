...
const deleteArticle = async (article: ArticleDto) => {
  client.articles.deleteById(article.id);
  const idx = props.articles.indexOf(article);
...
<template>
  <div v-if="props.editable" class="section-header">
    <Overlay>
      <template v-slot:card>
        <button class="create-btn">+ New Article</button>
      </template>
  ...
  <div v-if="props.articles.length" class="problems-list">
    <div v-for="(article,index) in props.articles" :key="index" class="problem-card">
      <div class="problem-info">
        <ArticleCard :article="article" @search-problem="handleSearchProblem"/>
      </div>
  ...
  <p v-else class="no-content">No articles.</p>
</template>
